...
public class GlobalExceptionHandler {
      ...
      return ResponseEntity
                ...
                .body(
                    ExceptionResponse.builder()
                        ...
                        .businessExceptionDescription(BusinessErrorCodes.BAD_CREDENTIAL.getDescription())
    ...
    public ResponseEntity<ExceptionResponse> handleException(EntityNotFoundException exp) {
        ...
        return ResponseEntity
                ...
                .body(
                    ExceptionResponse.builder()
                        .businessExceptionDescription("Risorsa non trovata.") // Messaggio più appropriato
                        .error(exp.getMessage())
                        .build()
                );
    }
    ...
    public ResponseEntity<ExceptionResponse> handleException(IllegalArgumentException exp) {
        ...
        return ResponseEntity
                ...
                .body(
                    ExceptionResponse.builder()
                        .businessExceptionDescription("Richiesta non valida.")
                        .error(exp.getMessage())
                        .build()
                );
    }
    ...
    public ResponseEntity<ExceptionResponse> handleException(Exception exp) {
        ...
        return ResponseEntity
                ...
                .body(
                    ExceptionResponse.builder()
                        .businessExceptionDescription("Errore interno del server, riprova più tardi.")
                        .error(exp.getMessage())
                        .build()
                );
    }
